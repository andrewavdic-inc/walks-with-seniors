        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm flex flex-col relative overflow-hidden group hover:border-teal-400 hover:shadow-xl transition">
              ...
              <button className="w-full py-4 rounded-xl font-bold text-teal-800 bg-teal-50 border border-teal-200 hover:bg-teal-600 hover:text-white transition">Get Started</button>
            </div>
            ...
            <div className="bg-teal-700 rounded-3xl p-8 border border-teal-600 shadow-2xl flex flex-col relative overflow-hidden transform md:-translate-y-4">
              ...
              <button className="w-full py-4 rounded-xl font-black text-teal-900 bg-white hover:bg-slate-100 shadow-lg transition">Get Started</button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <a href="tel:5551234567" className="text-slate-300 hover:text-white font-bold text-lg transition">Call: (555) 123-4567</a>
              <button className="bg-teal-500 hover:bg-teal-400 text-slate-900 px-6 py-3 rounded-full font-black transition">Request a Call</button>
            </div>
          </div>
